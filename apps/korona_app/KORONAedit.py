...
def set_image():
    ...
    path = 'G:\\PROGRAMOWANIE\\pycharm projects\\KORONAFILES\\images\\' + path_n
    img_base = PhotoImage(file=path)
...
def display(self):
    ...
    with open('G:\\PROGRAMOWANIE\\pycharm projects\\KORONAFILES\\data.txt') as file:
...
def api_check():
    key = 'AIzaSyDhE7O_c-6CE-ALObU9HHDmR42vHFyoGBc'
    origin = 'Wroclaw,53-522'
...
root.iconphoto(True, PhotoImage(file='G:\\PROGRAMOWANIE\\pycharm projects\\KORONAFILES\\images\\rooticon_3.png'))
